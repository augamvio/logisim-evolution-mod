...
In this modified version (based on version **4.1.0**), the following changes have been made:
...
`./logisim-evolution-4.1.0/src/main/java/com/cburch/logisim/fpga/download/AlteraDownload.java`
